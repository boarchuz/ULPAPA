...
public:
    ...
    NeoPixelBus(uint16_t countPixels, uint8_t pin, void *ptr) :
        _countPixels(countPixels),
        _state(0),
        _method(pin, ptr, countPixels, T_COLOR_FEATURE::PixelSize)
    {
    }

    NeoPixelBus(uint16_t countPixels, uint8_t pinClock, uint8_t pinData, void *ptr) :
        _countPixels(countPixels),
        _state(0),
        _method(pinClock, pinData, ptr, countPixels, T_COLOR_FEATURE::PixelSize)
    {
    }
